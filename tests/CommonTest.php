...
abstract class CommonTest extends PHPUnit_Framework_TestCase
{
    ...
    public function startsWithProvider()
    {
        return array(
            ...
            array(true, 'foo bars', array('x', 'foo bar')),
    ...
    public function endsWithProvider()
    {
        return array(
            ...
            array(true, 'foo bars', array('x', 'o bars')),
    ...
    public function containsProvider()
    {
        return array(
            ...
            array(true, 'This string contains foo bar', array('foo bar', 'none')),
            array(true, '12398!@(*%!@# @!%#*&^%',  ' @!%#*&^%'),
            ...
            array(false, 'This string contains foo bar', array('none')),
            array(false, 'This string contains foo bar', array('none', 'nan')),
            array(false, 'This string contains foo bar', 'foo bar '),
