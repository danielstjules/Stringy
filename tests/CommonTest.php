...
abstract class CommonTest extends PHPUnit_Framework_TestCase
{
    ...
    public function endsWithProvider()
    {
        return array(
            ...
            array(false, 'fòô bàřs', 'fòô BÀŘS', true, 'UTF-8'),
            array(true, 'foo bars', array('o bars')),
            array(true, 'FOO bars', array('o bars'), false),
            array(true, 'FOO bars', array('o BARs'), false),
            array(true, 'FÒÔ bàřs', array('ô bàřs'), false, 'UTF-8'),
            array(true, 'fòô bàřs', array('ô BÀŘs'), false, 'UTF-8'),
            array(false, 'foo bar', array('foo')),
            array(false, 'foo bar', array('foo bars')),
            array(false, 'FOO bar', array('foo bars')),
            array(false, 'FOO bars', array('foo BARS')),
            array(false, 'FÒÔ bàřs', array('fòô bàřs'), true, 'UTF-8'),
            array(false, 'fòô bàřs', array('fòô BÀŘS'), true, 'UTF-8'),
            array(true, 'foo bars', array('o bars', 'rs')),
            array(true, 'FOO bars', array('o bars', 'ar'), false),
            array(true, 'FOO bars', array('o BARs', 'rs'), false),
            array(true, 'FÒÔ bàřs', array('ô bàřs', 'none'), false, 'UTF-8'),
            array(true, 'fòô bàřs', array('ô BÀŘs', 'none'), false, 'UTF-8'),
            array(false, 'foo bar', array('foo', 'oo')),
            array(false, 'foo bar', array('foo bars', 'S')),
            array(false, 'FOO bar', array('foo bars', 'foo')),
            array(false, 'FOO bars', array('foo BARS', 'foo')),
            array(false, 'FÒÔ bàřs', array('fòô bàřs', 'none'), true, 'UTF-8'),
            array(false, 'fòô bàřs', array('fòô BÀŘS', 'NONE'), true, 'UTF-8'),
        );
    }
