...
abstract class CommonTest extends PHPUnit_Framework_TestCase
{
    ...
    public function startsWithProvider()
    {
        return array(
            ...
            array(false, 'fòô bàřs', array('fòô BÀŘ'), true, 'UTF-8'),
            array(true, 'foo bars', array('foo bar', 'foo', 'none')),
            array(true, 'FOO bars', array('foo bar', 'FOO', 'none'), false),
            array(true, 'FOO bars', array('foo BAR', 'bar'), false),
            array(true, 'FÒÔ bàřs', array('fòô bàř', 'baz'), false, 'UTF-8'),
            array(true, 'fòô bàřs', array('fòô BÀŘ', 'none'), false, 'UTF-8'),
            array(false, 'foo bar', array('bar', 'oo')),
            array(false, 'foo bar', array('foo bars', 'bar')),
            array(false, 'FOO bar', array('foo bars', 'OO')),
            array(false, 'FOO bars', array('foo BAR', 'foo')),
            array(false, 'FÒÔ bàřs', array('fòô bàř', 'none'), true, 'UTF-8'),
            array(false, 'fòô bàřs', array('fòô BÀŘ', 'NONE'), true, 'UTF-8'),
        );
    }
